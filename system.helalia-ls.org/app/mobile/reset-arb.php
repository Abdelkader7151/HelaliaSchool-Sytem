...
<div class="app app--auth"><div class="auth">
    ...
    <div class="auth__brand">
      ...
      <h1 class="auth__name">        إعادة تعيين كلمة المرور  </h1>
    
    </div>
    
    <form class="auth__form" method="post" autocomplete="on" action="reset-arb.php?id=<?php echo $_SESSION['phone_id'];?>&code=<?php echo escape($_GET['code']);?>">
      <label class="field"><span class="field__label">    كلمه المرور الجديدة</span><input class="input" type="text" inputmode="numeric" placeholder="••••" required name="password" minlength="4" style="text-align:center"></label>
      <button class="btn btn--gold" name="submit"  type="submit">  حفظ كلمه المرور</button>
