...
<div class="app">
   <header class="hero hero--tall">
        <div class="hero__row">
          <a class="back" href="parent-alerts.php?kid=<?php echo $kid_id;?>" aria-label="Back">
  ...
  <main class="page">
    <article class="card adet">
      ...
      <div class="adet__actions">
        <a class="btn btn--quiet"  href="parent-alerts.php?kid=<?php echo $kid_id;?>">Back to alerts</a>
        <a class="btn btn--danger" href="parent-alerts.php?kid=<?php echo $kid_id;?>&del=<?php echo $id;?>" type="button">Delete</a>
      </div> 
    </main>
