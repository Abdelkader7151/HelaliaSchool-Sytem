...
$query_get_users_info = "SELECT * FROM `kids_reg` WHERE `id` >0 $study_year order by `name` asc  ";   
        ...
        <div class="layout-content-body"> 
            ...
            <div class="col-md-12">
                ...
                <select class="form-control"  name="study_year" id="study_year" onchange="if (this.value) window.location.href=this.value"  >
                      <option  >...</option> 
                      <option value="reg-kid-list.php"  >الجميع</option> 
                ...
                <table id="court-datatables" class="table table-striped  dataTable" width="100%" style="font-size: 16px;  ">
                    <thead> 
                      <tr>  
                        ...
                        <th class="text-center">سنة الالتحاق</th>  
                    ...
                    <tbody>
                      ...
                      <tr class="count">  
                        ...
                        <td class="text-center"><?php if($row_get_users_info['birthday']>0){echo date("m/d/Y",$row_get_users_info['birthday']);}?></td> 
                         ...
                         <td class="text-center"><?php echo $row_get_users_info['join_year'];?></td>  
                        </td>
                        ...
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"> 
                                <li><a href="view-reg-kid.php?id=<?php echo $row_get_users_info['id'];?>" >  <i class="fa fa-eye" aria-hidden="true" style="color: green"></i>  عرض </a></li> 
                                <li><a href="edit-reg-kid.php?id=<?php echo $row_get_users_info['id'];?>" >  <i class="fa fa-pencil-square-o" aria-hidden="true" style="color: green"></i>  تعديل </a></li>   
                                <li role="separator" class="divider"></li> 
								<li><a href="edit-reg-kid.php?del=<?php echo $row_get_users_info['id'];?>" onClick="return confirm('تاكيد؟');">  <i class="fa fa-trash-o" aria-hidden="true" style="color: red"></i>  حذف </a></li>
