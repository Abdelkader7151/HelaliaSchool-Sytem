...
$query_get_class_info = "SELECT * FROM `video-albums` order by `id` asc  "; 
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			...
			<div class="row">
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td class="text-center"><?php echo check_video_gallery($row_get_class_info['id']);?></td> 
                ...
                <li><a href="edit-video-album.php?id=<?php echo $row_get_class_info['id'];?>" >  <i class="fa fa-pencil-square-o" aria-hidden="true" style="color: green"></i>  تعديل </a></li>
                            <?php if(check_video_gallery($row_get_class_info['id'])==0){?>    
                                 <li role="separator" class="divider"></li> 
								<li><a href="edit-video-album.php?del=<?php echo $row_get_class_info['id'];?>" onClick="return confirm('تاكيد؟');">  <i class="fa fa-trash-o" aria-hidden="true" style="color: red"></i>  حذف </a></li>
                            <?php }?>    
                            </ul>
                          </div>
                        </td>
