...
<div class="app">
 <header class="hero hero--tall">
    <div class="hero__row">
        <a class="back" href="parent-ask.php?kid=<?php echo $row_get_kid_data['id'];?>" aria-label="رجوع">
  ...
  <main class="page">
   ...
   <?php if($subject_id==10001 ){?><div class="ask-head"><i class="fa fa-university" aria-hidden="true"></i><span>الإدارة</span></div><?php } ?>
   <?php if($subject_id==10002){?><div class="ask-head"><i class="fa fa-graduation-cap" aria-hidden="true"></i><span>رئيس القسم</span></div><?php } ?>
   <?php if($subject_id==10003){?><div class="ask-head"><i class="fa fa-graduation-cap" aria-hidden="true"></i><span>وكيل المدرسة</span></div><?php } ?>
   <?php if($subject_id==10004){?><div class="ask-head"><i class="fa fa-sitemap" aria-hidden="true"></i><span>السكرتارية</span></div><?php } ?>
   <?php if($subject_id==10005){?><div class="ask-head"><i class="fa fa-user-md" aria-hidden="true"></i><span>الطبيب</span></div><?php } ?>
   <?php if($subject_id==10006){?><div class="ask-head"><i class="fa fa-handshake-o" aria-hidden="true"></i><span>الأخصائي النفسي</span></div><?php } ?>
   <?php if($subject_id<1000){?><div class="ask-head"><i class="fa fa-book" aria-hidden="true"></i><span>منسق</span></div><?php } ?>
        ...
        <form action="parent-ask-teacher.php?kid=<?php echo $kid_id;?>&subject=<?php echo $subject_id;?>" method="post" enctype="multipart/form-data" name="send-form" id="send-form">
              ...
              <div class="ask-success" id="done"><i class="fa fa-check-circle" aria-hidden="true"></i> تم الإرسال بنجاح</div>
            <?php }?>
