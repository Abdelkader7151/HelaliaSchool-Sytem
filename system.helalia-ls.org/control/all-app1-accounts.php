...
$query_get_users_info = "SELECT * FROM `app_login` where `account_type` = 1 order by `name` asc  "; 
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4>عرض   حسابات اولياء الامور  </h4>
            </div>
          </div>
			<div class="row">
				<div class="col-md-12">
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    <thead>
                      <tr> 
                        ...
                        <th class="text-center"> الاطفال المسجلة</th> 
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td class="text-center"><?php echo $row_get_users_info['email'];?></td> 
                        <td class="text-center"><?php echo $row_get_users_info['phone'];?></td> 
                        <td class="text-center"><?php if($row_get_users_info['gender']==1){echo "ذكر";}elseif($row_get_users_info['gender']==2){echo "انثي";}?></td> 
                        <td class="text-center"><?php echo date("m/d/Y",$row_get_users_info['date']);?></td> 
                        <td class="text-center"><?php echo added_kids($row_get_users_info['id']);?></td> 
