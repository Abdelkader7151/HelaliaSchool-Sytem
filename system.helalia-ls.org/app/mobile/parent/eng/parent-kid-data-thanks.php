...
<div class="app">
    ...
    <div class="hero__row">
      <a class="back" href="parent-view.php" aria-label="Back">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          <path d="M15 19 8 12l7-7"/></svg></a><h1 class="hero__title">Thank YOU</h1>
  ...
  <div class="thanks">
    ...
    <p class="thanks__body">We will confirm your data and activate your account.</p>
  </div>
