...
$query_get_class_info = "SELECT * FROM `events` order by `start` asc  "; 
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td class="text-left"><?php echo $row_get_class_info['name_arb'];?></td>  
                        <td class="text-left"><?php echo year_of_study($row_get_class_info['study_year']);?></td> 
                        <td class="text-center"><?php echo date("d/m/Y",$row_get_class_info['start']);?></td> 
                        <td class="text-center"><?php echo date("d/m/Y",$row_get_class_info['end']);?></td> 
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"> 
                               <li><a href="edit-event.php?id=<?php echo $row_get_class_info['id'];?>" >  <i class="fa fa-pencil-square-o" aria-hidden="true" style="color: green"></i>  تعديل </a></li>
                              
							   <li><a href="edit-event.php?del=<?php echo $row_get_class_info['id'];?>" onClick="return confirm('تاكيد؟');">  <i class="fa fa-trash-o" aria-hidden="true" style="color: red"></i>  حذف </a></li>
