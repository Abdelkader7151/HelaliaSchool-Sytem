...
<div class="app">
  <header class="hero hero--tall">
    ...
    <div class="hero__row">
      <a class="back" href="parent-memo.php?id=<?php echo $kid_id; ?>" aria-label="Back">
                      ...
                      <div class="fold t-coral">     
                        <button class="fold__head" type="button">
                          ...
                          <span class="fold__body">
                            ...
                            <span class="row__meta"><?php echo $totalRows_get_memo_videos;?> clips</span>
                          </span>
    ...
    <div class="fold t-gold">
      <button class="fold__head" type="button">
        ...
        <span class="fold__body">
          ...
          <span class="row__meta"><?php echo $totalRows_get_memo_links;?> link</span>
        </span>
        <span class="fold__chev">›</span>
      </button>
      <div class="fold__panel">
