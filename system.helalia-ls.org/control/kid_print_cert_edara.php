...
<?php } } ?> 
 ...
 <div class="col-xs-4" style="text-align: center;"><h3 style="font-size: 18px; font-weight:bold; padding:0px; margin:0px">رئيس لجنة النظام و المراقبة </h3></div>
 <div class="col-xs-4" style="text-align: center;"><h3 style="font-size: 18px; font-weight:bold; padding:0px; margin:0px">  </h3></div>

 <div class="col-xs-4" style="text-align: center;"><h3 style="font-size: 18px; font-weight:bold; margin-top:-4px">مدير التعليم  
