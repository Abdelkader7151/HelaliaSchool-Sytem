...
<div class="app">
    ...
    <div class="hero__row">
      <a class="back" href="parent-kid.php?id=<?php echo $row_get_kid_data['id'];?>" aria-label="Back">
        ...
        <h1 class="hero__title">Weekly plan</h1>
        <div class="bells">
...
<p class="hero__lede">Thursday to Thursday</p>
  </header>
  ...
  <main class="page">
      <div class="week">
        <div class="weekhead">
          <span class="weekhead__range"><?php  echo $range['start_label'] . ' → ' . $range['end_label'];?></span>
          <span class="weekhead__tag weekhead__tag--now">This week</span>
        </div>   
 <div class="plan">   
