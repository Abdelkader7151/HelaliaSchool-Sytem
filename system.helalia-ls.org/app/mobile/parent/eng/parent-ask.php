...
<div class="app">
   <header class="hero hero--tall">
    <div class="hero__row">
      <a class="back" href="parent-kid.php?kid=<?php echo $row_get_kid_data['id'];?>" aria-label="Back">
    ...
    <div class="new-msg-modal__box" role="dialog" aria-modal="true" aria-labelledby="new-message-title">
      ...
      <div id="new-message-body">
        ...
        <ul class="collapsible">
          <li>
            <div class="collapsible-header"><i class="fa fa-book" aria-hidden="true"></i> Coordinator</div>
                ...
                <?php if($totalRows_get_subjects>0 && check_teacher_subject($row_get_subjects['id'])>0){
                        ...
                        <div class="col s6">
                            ...
                            <a href="parent-ask-teacher.php?kid=<?php echo $kid_id;?>&subject=<?php  echo $row_get_subjects['id'];?>">
                                ...
                                <?php  echo $row_get_subjects['name_eng'];?>
                            </a>
                            </div>
                        </div> 
