<?php require_once('includes/access.php'); 
 ...
 if($row_get_login['access10']==1){
    ...
    $query_get_app_info = "SELECT * FROM `requests_attend` WHERE `id`='{$_GET['id']}'  ";
  ...
  mysqli_select_db($database, $database_database); 
  $query_get_kids_list = "SELECT * FROM `kids_list` where `parent_id`='{$row_get_app_info['parent_id']}'  ";
        ...
        <div class="layout-content-body"> 
			...
			<div class="row"> 
			 ...
			 <div class="form-group">
              ...
              <div class="col-sm-3">
                <input id="name" class="form-control" required type="text" name="name" readonly value="<?php echo parent_app($row_get_app_info['parent_id']);?>">
              </div>
              <div class="col-sm-1" style="padding-top: 7px;">
              <a href="view-app-account.php?id=<?php echo $row_get_app_info['parent_id'];?>" class="btn btn-xs btn-danger btn-block"  > <i class="fa fa-eye" aria-hidden="true"></i>  عرض   </a>
              </div>
            </div>  
...
<div class="form-group">
              ...
              <div class="col-sm-6" style="border: solid 1px black; padding:20px; margin-top:10px" >
                 <p><?php echo $row_get_app_info['msg'];?></p>
              </div> 
            </div>  
