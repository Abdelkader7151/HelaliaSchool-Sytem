...
<header class="hero hero--tall">
    <div class="hero__row">
      <a class="back" href="parent-view.php" aria-label="رجوع">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          <path d="M15 19 8 12l7-7"/></svg></a><h1 class="hero__title">إضافة طالب جديد</h1>
         <div class="bells">
  ...
  <main class="page page--fab">
    ...
    <div class="card stack">
      <div class="sec"><h2 class="sec__title">بيانات الطالب</h2></div>
      <label class="field"><span class="field__label">الاسم <span class="req">*</span></span><input class="input" id="name" name="name" type="text" required></label>
      <label class="field"><span class="field__label">رقم التعليم <span class="req">*</span></span><input class="input" id="ed_id" name="ed_id" type="number" inputmode="numeric" required></label>
      <label class="field"><span class="field__label">الرقم القومي أو جواز السفر <span class="req">*</span></span><input class="input" id="gov_id" name="gov_id"  type="text" maxlength="14" required></label>
 ...
 <?php }
    ...
    <div class="hl-modal" id="wrong-password" role="alertdialog" aria-live="assertive" aria-label="Login error">
      <div class="hl-modal__box">
        ...
        <p class="hl-modal__text">لم يتم العثور على الطالب</p>
      </div>
    </div>
  ...
  <?php } if ($error == 2) { ?>  
    ...
    <div class="hl-modal" id="phone-linked" role="alertdialog" aria-live="assertive" aria-label="Device notice">
      <div class="hl-modal__box">
        ...
        <p class="hl-modal__text">هذا الطالب مضاف بالفعل إلى حسابك</p>
      </div>
    </div>
