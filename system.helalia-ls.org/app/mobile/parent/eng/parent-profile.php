...
<div class="app">
  ...
  <main class="page">
    ...
    <div class="card stack"> 
       <!--<div class="row-flex">
          <span class="av av--lg t-gold">SA</span>
          <div class="grow">
            <p class="row__title">Sara Ahmed</p>
            <p class="row__meta">Parent</p>
          </div>
        </div> -->


        <label class="field"><span class="field__label">Full name</span><input class="input" type="text" placeholder="" require name="name" value="<?php echo $row_get_user['name'];?>"></label> 
        <label class="field"><span class="field__label">Email</span><input class="input" type="email" placeholder="" require name="email" value="<?php echo $row_get_user['email'];?>"></label>
