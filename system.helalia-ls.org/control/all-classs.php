...
$query_get_class_info = "SELECT * FROM `class` order by `id` asc  "; 
        ...
        <div class="layout-content-body"> 
			...
			<div class="row">
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    <thead>
                      <tr> 
                       <th class="text-center">كود الفصل</th> 
                        <th class="text-center">المرحلة</th> 
                        <th class="text-left">الاسم  </th> 
                        <th class="text-center">عدد الطالبات  </th> 
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td class="text-center"><?php echo count_class_kid($row_get_class_info['id']);?></td> 
                ...
                <li><a href="edit-class.php?id=<?php echo $row_get_class_info['id'];?>" >  <i class="fa fa-pencil-square-o" aria-hidden="true" style="color: green"></i>  تعديل </a></li>
                <?php if($row_get_login['access1sub4']==1){?>
                <li><a href="all-class-kids.php?id=<?php echo $row_get_class_info['id'];?>" >  <i class="fa fa-users" aria-hidden="true" style="color: green"></i>  الطلبة </a></li>
                <?php } if(count_class_kid($row_get_class_info['id'])<1){?>
                <li role="separator" class="divider"></li> 
                 ...
                 <?php }?>   
                 <li><a href="class-announce.php?id=<?php echo $row_get_class_info['id'];?>" >  <i class="fa fa-bullhorn" aria-hidden="true" style="color: green"></i>  منشور </a></li>            
                            </ul>
                          </div>
                        </td>
                      </tr>
