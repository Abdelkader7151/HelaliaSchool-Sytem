...
if(isset($_GET['id'])){ 
   ...
   $query_get_users_info = "
   SELECT 
       kids.*, 
       data_form_kids.phone,
       data_form_kids.address,
       (SELECT `name` FROM `class` WHERE `class`.id = `kids`.class) AS `class_name`
   FROM kids
   LEFT JOIN data_form_kids 
   ON kids.id = data_form_kids.kid_id
   WHERE kids.id > 0 $study_year 
        ...
        <div class="layout-content-body"> 
			...
			<div class="row"> 
                   ...
                   <div class="col-xs-12" style="padding: 20px;"> 
                    ...
                    <div class="col-md-2" style="font-weight: bold; display:none"><a href="all-kids.php?reg1<?php if(isset($_GET['id'])){echo "&id=".$_GET['id'];}?>">مسلم</a> : <span id="reg1"></span></div>
                    <div class="col-md-2" style="font-weight: bold; display:none"><a href="all-kids.php?reg2<?php if(isset($_GET['id'])){echo "&id=".$_GET['id'];}?>">مسيحي</a> : <span id="reg2"></span></div>
                   ...
                   <a href="kids-transfer.php?id=<?php echo $_GET['id'];?>" class="btn btn-danger btn-block" >ترحيل الي <?php echo year_of_study($_GET['id']+1);?> </a>
                   <?php }?>
                    </div>
                  </div> 
                ...
                <table id="court-datatables" class="table table-striped  dataTable" width="100%" style="font-size: 16px;  ">
                  ...
                  <td class="text-left">
                      <?php echo year_of_study($row_get_users_info['study_year']);?>
                        </td>

                      <td class="text-left">
                      <?php echo study_type($row_get_users_info['study_type']);?>
                         </td>
                      ...
                      <!--  <td class="text-center"><?php //echo $row_get_users_info['birth_place'];?></td> 
                        ...
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <?php } if($row_get_users_info['linked']==1 && $row_get_login['access7sub8']==1){ ?>
