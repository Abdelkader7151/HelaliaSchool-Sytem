          ...
          <div class="row">
				<div class="col-md-12">
				  <div class="demo-form-wrapper">
                    ...
                    <label class="col-sm-2 control-label" for="date">       تاريخ اليوم <span style="color: red;">*</span></label>
                    <div class="col-sm-2">
                        <input id="date" class="form-control" required type="date" name="date"  style="text-align: left;">
                    </div>
                    </div>
