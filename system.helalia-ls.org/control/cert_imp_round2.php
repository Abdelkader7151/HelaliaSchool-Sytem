...
function removes($name) {
  ...
  return $step19;
    ...
    if(isset($_POST['import'])){    
        // الدور الثاني always stored as type = 4
        $_POST['type'] = 4;
        if(empty($_POST['title_arb'])){ $_POST['title_arb'] = 'الدور الثاني'; }
        if(empty($_POST['title_eng'])){ $_POST['title_eng'] = 'Second Sitting'; }
            ...
            if($totalRows_get_data && $error==0){
              ...
              do{  
                ...
                $insertSQL2 = sprintf("INSERT INTO `certificate` (
                  ...
                  if ($Result2 && helalia_cert_is_pass($row_get_data)) {
                      helalia_cert_promote_kid($database, $row_get_data['gov_id'], $row_get_data['study_year']);
                  }
...
$head_title = " النتائج (الدور الثاني)";
 ?> 
<!DOCTYPE html>
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4> تحميل نتيجة الدور الثاني </h4>
            </div>
          </div>
			<div class="row">  
				<div class="col-md-4">
				  <div class="demo-form-wrapper"> 
                    <form action="cert_imp_round2.php" method="POST" name="form1" id="demo-inputmask2"  enctype="multipart/form-data" class="form form-horizontal">
                    
 
		       <div class="form-group">
              <label class="col-sm-3 control-label" for="title_arb">  العنوان عربي   </label>
              <div class="col-sm-6">
                <input id="title_arb" class="form-control"  type="text" name="title_arb" value="الدور الثاني" required >
              </div>
            </div>  
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input id="title_eng" class="form-control" type="text" style="text-align: left;" name="title_eng" value="Second Sitting" required >
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="file" required name="excel" accept=".xls,.xlsx"   class="form-control" />  
                <small style="color:browne">الملف Excel فقط —
                  <a href="../excel/J32.xlsx">Demo J32</a> |
                  <a href="../excel/m22.xlsx">Demo m22</a>
                </small>
            ...
            <div class="form-group">
                ...
                <strong>الدور الثاني (Second Sitting)</strong>
						</div>
            </div>  
