...
$query_get_new_contacts = "SELECT * FROM `requests_attend`  order by `id` desc "; 
...
$head_title = "  رسائل الي اولياء الامور";
 ?> 
<!DOCTYPE html>
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    <thead>
                      <tr>   
                        ...
                        <th class="text-center"> تاريخ   Y/M/A </th>  
                    ...
                    <tbody>
						...
						<?php if($totalRows_get_new_contacts>0){
	                           do{  ?>
                      <tr>  
                        <td class="text-left"><?php echo parent_app($row_get_new_contacts['parent_id']);?></td>  
                        <td class="text-center"><?php echo date("Y/m/d",$row_get_new_contacts['date']);?></td>  
                        <td class="text-center"><?php echo users_name($row_get_new_contacts['emp_id']);?></td>  
                        ...
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"> 
                                ...
                                <li><a href="view-request-msg.php?id=<?php echo $row_get_new_contacts['id'];?>" >  <i class="fa fa-eye" aria-hidden="true" style="color: green"></i>  عرض </a></li>
