...
if(isset($_POST['submit'])){  
    ...
    include("includes/img-up2.php");
      	$insertSQL = sprintf("INSERT INTO `gallery-albums` ( `year`, `title`, `link`) VALUES ( %s, %s, %s )", 
      ...
      $query_get_data = "SELECT * FROM `gallery-albums` WHERE `year`='{$_POST['year']}' ORDER BY `id` DESC limit 1";
      ...
      $totalRows_get_gallery_albums = mysqli_num_rows($get_gallery_albums); 
        ...
        header("location: edit-photo-album.php?id=".$row_get_data['id']."&done"); 
        exit();
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			...
			<div class="row">
				<div class="col-md-8">
				  <div class="demo-form-wrapper">
                    <form action="new-photo-album.php" method="post" name="form1" id="demo-inputmask"  enctype="multipart/form-data" class="form form-horizontal">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label" for="year"><i class="fa fa-spinner fa-spin fa-fw" style="color: blue; display: none;" id="loading"></i> المرحلة  <span style="color: red;">*</span> </label>
              <div class="col-sm-3">
