                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    <thead>
                      <tr> 
                        ...
                        <th class="text-center">تاريخ التعين M/D/Y</th>
                        <th class="text-center"> تاريخ الميلاد M/D/Y </th> 
                        <th class="text-center">البرنامج</th>
                        <th class="text-center">حضور و انصراف</th>
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td class="text-center"><?php if($row_get_users_info['start_date']!=null){echo date("m/d/Y",$row_get_users_info['start_date']);}?></td> 
                        ...
                        <td class="text-center"><?php echo $row_get_users_info['ext_id'];?></td> 
