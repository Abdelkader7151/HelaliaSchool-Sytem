...
include("includes/img-up1.php");
	...
	$insertSQL = sprintf("INSERT INTO `kids_reg` ( `lang`, `picture`, `gov_id`, `ed_id`,`name`, `fn_name`, `study_type`, `join_year`, `responsible`, `gender`, `email`, `birthday`, `october_age_d`, `october_age_m`, `october_age_y`, `transfare`, `religion`, `nationality`, `birth_place`, `father_details`,   `home_phone`, `other_phone`, `mother_mobile`, `father_mobile`, `other_mobile`, `study_year`, `from_school`, `school_ed`, `transfare_comment`, `emp`, `date`) VALUES ( %s, %s, %s, %s, %s,  %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )",
       ...
       $Result1 = mysqli_query($database,$insertSQL) or die(mysqli_error($database));
			...
			if($Result1) {
				header("location: reg-kid.php?done"); 
				exit();
			}
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4> تسجيل طالب للالتحاق بالمدرسة </h4>
            </div>
          </div>
			<div class="row">
				<div class="col-md-8">
				  <div class="demo-form-wrapper">
                    <form action="reg-kid.php" method="post" name="form1" id="demo-inputmask"  enctype="multipart/form-data" class="form form-horizontal">
            ...
            <div class="form-group">
						...
						<div class="col-sm-2"  >
                            <select class="form-control"  name="join_year" id="join_year" >
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                 <input id="ed_id" class="form-control" type="number" name="ed_id"  > 
...
<h3>بيانات المدرسة المحول من</h3>
            ...
            <label class="col-sm-3 control-label" for="from_school">     المدرسة المحول من  </label>
              <div class="col-sm-4">
                <input id="from_school" class="form-control"   type="text" name="from_school">
              </div>
            </div>
            ...
            <label class="col-sm-3 control-label" for="school_ed"> الإدارة التعليمية التابع له  </label>
              <div class="col-sm-4">
                <input id="school_ed" class="form-control"   type="text" name="school_ed">
              </div>
            </div>
            ...
            <label class="col-sm-3 control-label" for="transfare_comment">         سبب التحويل  </label>
              <div class="col-sm-4">
                <input id="transfare_comment" class="form-control"   type="text" name="transfare_comment">
              </div>
            </div>
