<?php require_once('includes/access.php'); 
 ...
 if($row_get_login['access2sub4']==1){
  ...
  if(isset($_GET['del'])){   
    ...
    $deleteSQL = sprintf("DELETE FROM `classgroup_list` WHERE `classgroup_id`=%s and `kid_id`=%s ",
            ...
            header("location: all-classgroup-kids.php?id=".$_GET['id']); 
            exit(); 
    } 
...
mysqli_select_db($database, $database_database);  
$query_get_class_info = "SELECT * FROM `classgroup_list` where `classgroup_id` = '{$_GET['id']}' "; 
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4>عرض جميع الطلبة في مجموعة التقوية<strong> <?php echo classgroup_name($_GET['id']);?> </strong>  
                <?php echo year_of_study(classgroup_year($_GET['id']));?> </h4>
            </div>
          </div>
			<div class="row">
				<div class="col-md-12">
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    ...
                    <tbody>
						...
						<?php if($totalRows_get_class_info>0){
	                           do{  ?>
                      <tr> 
                        <td class="text-left"><?php echo kid_name($row_get_class_info['kid_id']);?></td>  
                        ...
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <li><a href="view-kid.php?id=<?php echo $row_get_class_info['kid_id'];?>" >  <i class="fa fa-eye" aria-hidden="true" style="color: green"></i>  عرض </a></li>
                          
                            <li role="separator" class="divider"></li> 
								            <li><a href="all-classgroup-kids.php?id=<?php echo $_GET['id'];?>&del=<?php echo $row_get_class_info['kid_id'];?>" onClick="return confirm('تاكيد؟');">  <i class="fa fa-trash-o" aria-hidden="true" style="color: red"></i>  حذف </a></li>
