...
<div class="modal-overlay" id="file-size-modal" style="display:none;">
  <div class="modal-box">
    ...
    <h3 class="modal-title">حجم الملف كبير جدًا</h3>
    <p class="modal-text" id="file-size-modal-text">حجم هذا الملف أكبر من 10 ميجابايت. يرجى اختيار ملف أصغر.</p>
    <button class="btn btn--primary" id="file-size-modal-close" type="button">تمام</button>
  </div>
</div>
...
<div class="modal-overlay" id="date-range-modal" style="display:none;">
  <div class="modal-box">
    ...
    <h3 class="modal-title">تواريخ غير صالحة</h3>
    <p class="modal-text">يجب أن يكون تاريخ "إلى" بعد تاريخ "من".</p>
    <button class="btn btn--primary" id="date-range-modal-close" type="button">تمام</button>
  </div>
</div>
...
<header class="hero hero--tall">
    <div class="hero__row">
        <a class="back" href="parent-summary.php?kid=<?php echo $kid_id;?>" aria-label="رجوع">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <label class="field">
              <span class="field__label">نوع الطلب</span>
                <select class="input" id="vac-type" name="type">
                    ...
                    <option value="2">بطوله</option>
                    <option value="3">سفر</option> 
                    <option value="4">آخر</option>
                </select>
            </label>

        <label class="field"><span class="field__label">من</span><input class="input datepicker" type="date" id="vac-from" name="start" required></label>
        <label class="field"><span class="field__label">الي</span><input class="input datepicker" type="date" id="vac-to" name="end" required></label>
         <label class="field" style="text-align: center; padding-top:20px"> <span id="number_days" style="color: orangered; font-size:24px;">0 <span style="font-size: 20px;  color:#112c5a">ايام</span></span> </label>
        <label class="field"><span class="field__label">السبب</span><textarea class="input" name="text" id="vac-reason" placeholder="أخبر المدرسة بالسبب..."></textarea></label>
       

         

        <div class="field">
          <span class="field__label">مرفقات</span>
          <label class="upload">
            ...
            <span class="upload__body">
              <span class="upload__title">تحميل المرفق</span>
              <span class="upload__meta" id="vac-file-name">صورة أو ملف PDF · الحد الأقصى 10 ميجابايت</span>
            </span>
          </label>
        </div>

 
         <button class="btn btn--primary " name="submit" type="submit"><i class="fa fa-paper-plane-o" aria-hidden="true"></i> إرسال الطلب <i class="fa fa-spinner fa-spin fa-fw" style="display: none;" id="loading"></i></button>
      </div>
  </form>
