...
<div class="app">
    ...
    <div class="hero__row">
      <a class="back" href="parent-homework-view.php?id=<?php echo $row_get_data['subject'];?>&kid=<?php echo $kid_id; ?>" aria-label="رجوع">
                      ...
                      <div class="fold t-coral">     
                        <button class="fold__head" type="button">
                          ...
                          <span class="fold__body">
                            ...
                            <span class="row__meta"><?php echo $totalRows_get_homework_videos;?> ملف</span>
                          </span>
    ...
    <div class="fold t-gold">
      <button class="fold__head" type="button">
        ...
        <span class="fold__body">
          ...
          <span class="row__meta"><?php echo $totalRows_get_homework_links;?> رابط</span>
        </span>
        <span class="fold__chev">›</span>
      </button>
      <div class="fold__panel">
