...
! function(a) {
    ({
        ...
        handleSidenavCollapseStart: function(a) {
            this.getThemeSettingsBy(this.CssClasses.LAYOUT_SIDEBAR_COLLAPSED).prop("checked", !0)
        },
        handleSidenavExpandStart: function(a) {
            this.getThemeSettingsBy(this.CssClasses.LAYOUT_SIDEBAR_COLLAPSED).prop("checked", !1)
        },
        ...
        changeThemeSettings: function(b) {
            return a.each(b, function(a, b) {
                this.getThemeSettingsBy(a).prop("checked", b).trigger("change")
            }.bind(this)), this
        },
        ...
        setSidebarFixed: function(a) {
            ...
            if (this.$layout.toggleClass(this.CssClasses.LAYOUT_SIDEBAR_FIXED, a), !this.isSidebarFixed()) return this.removeCustomScrollbarFrom(c);
            this.isHeaderStatic() && (b[this.CssClasses.LAYOUT_HEADER_FIXED] = a), this.isSidebarSticky() && (b[this.CssClasses.LAYOUT_SIDEBAR_STICKY] = !a), this.changeThemeSettings(b).addCustomScrollbarTo(c)
        },
        ...
        setSidebarSticky: function(a) {
            var b = {};
            if (this.$layout.toggleClass(this.CssClasses.LAYOUT_SIDEBAR_STICKY, a), !this.isSidebarSticky()) return this.destroyStickySidebar();
            this.isHeaderStatic() && (b[this.CssClasses.LAYOUT_HEADER_FIXED] = a), this.isSidebarFixed() && (b[this.CssClasses.LAYOUT_SIDEBAR_FIXED] = !a), this.changeThemeSettings(b).createStickySidebar()
        },
        ...
        updateStickySidebar: function() {
            this.getSidebarScrollableArea().hcSticky("reinit")
        },
