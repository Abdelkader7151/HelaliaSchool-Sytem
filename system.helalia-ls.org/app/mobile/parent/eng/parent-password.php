...
<div class="app">
  <header class="hero hero--tall">
    <div class="hero__row">
      <a class="back" href="parent-settings.php" aria-label="Back">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          <path d="M15 19 8 12l7-7"/></svg></a><h1 class="hero__title">Change password</h1>
        <div class="bells">
  ...
  <main class="page">
   ...
   <form method="post" enctype="multipart/form-data"   > 
       <div class="card stack">
        <label class="field"><span class="field__label">Current password</span><input class="input"  minlength="4" type="password" name="old_password" required placeholder="••••••••"></label>
        <label class="field"><span class="field__label">New password</span><input class="input" type="text" minlength="4"  name="password" required placeholder="••••••••"></label> 
...
<?php if ($wrong == 1) { ?> 
    ...
    <div class="hl-modal" id="wrong-password" role="alertdialog" aria-live="assertive" aria-label="Login error">
      <div class="hl-modal__box">
        ...
        <p class="hl-modal__text">Wrong  password</p>
      </div>
    </div>
