...
$query_get_kids_vacations = "SELECT * FROM `emps_vacations` where `emp_id` = '{$_GET['id']}' order by `date` asc  "; 
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4>عرض الاجازات لموظف / <?php echo  emp_name($_GET['id']);?></h4>  
            </div>
          </div>
 ...
 <script>
	  $(document).ready(function(){ 
		...
		$("#court-datatables").DataTable({ 
            ...
            "aoColumnDefs": [
               { "bSortable": false,
			     "aTargets": [ <?php if(!isset($_GET['id'])){echo 4;}else{echo 3;}?> ]  
			   }
			 ]
        }); 
