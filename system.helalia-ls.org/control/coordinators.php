...
$query_get_class_info = "SELECT distinct `cor` FROM `subjects` WHERE `cor` > 0 "; 
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    <thead>
                      <tr>   
                        ...
                        <th class="text-center">المدرسين</th> 
                    ...
                    <tbody>
                      ...
                      <tr>   
                        ...
                        <td class="text-center"><?php echo cor_counter($row_get_class_info['cor']);?></td>  
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">  
                                 <li><a href="add-cor-teachers.php?id=<?php echo $row_get_class_info['cor'];?>" >  <i class="fa fa-plus" aria-hidden="true" ></i>  اضافة مدرس </a></li> 
                                 <li><a href="all-cor-teachers.php?id=<?php echo $row_get_class_info['cor'];?>" >  <i class="fa fa-graduation-cap" aria-hidden="true" ></i>  المدرسين </a></li>  
