<?php require_once('includes/access.php'); 
 ...
 if($row_get_login['access5sub4']==1){

mysqli_select_db($database, $database_database);  
$query_get_class_info = "SELECT * FROM `emps` where `job` = '{$_GET['id']}' order by `name` asc  "; 
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4>عرض جميع الموظفين على وظيفة <?php echo job_name($_GET['id']);?>  </h4>
            </div>
          </div>
			<div class="row">
				<div class="col-md-12">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <?php  if($row_get_login['access6sub3']==1){?>
                          <a href="edit-emp.php?id=<?php echo $row_get_class_info['id'];?>" class="btn btn-primary btn-xs " >  <i class="fa fa-pencil-square-o" aria-hidden="true" ></i>  تعديل </a>
                        <?php }?>
                        </td>  
                      </tr>
