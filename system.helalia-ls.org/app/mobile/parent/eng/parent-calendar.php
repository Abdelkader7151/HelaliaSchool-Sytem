  ...
  <header class="hero hero--tall">
    <div class="hero__row">
      <a class="back" href="parent-kid.php?id=<?php echo $row_get_kid_data['id'];?>" aria-label="Back">
        ...
        <h1 class="hero__title">Calendar</h1>
        <div class="bells">
...
<p class="hero__lede">School events for <?php echo date("Y",time());?>.</p>
  </header>
  ...
  <main class="page">
      ...
      <p class="ykey"><span class="ykey__dot"></span>Days with an event are marked.</p>
    
      <div class="sec">
        <h2 class="sec__title">Events</h2>
      </div>
  ...
  <div class="modal" id="ev-modal" role="dialog" aria-modal="true" aria-labelledby="ev-title">
    <div class="modal__card">
      ...
      <button class="btn btn--quiet modal__close" id="ev-close" type="button">Close</button>
    </div>
  </div>
</div>
  ...
  function renderList(EVENTS) {
    ...
    eventKeys.forEach(function (k) {
      ...
      rows += '<div class="cal cal--fold ' + ev[2] + '" style="align-items:flex-start">' +
        ...
        '<div class="cal__more" style="margin-left:-50px">' + ev[1] + '</div></div>' +
