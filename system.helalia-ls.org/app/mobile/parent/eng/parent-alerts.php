...
<div class="app">
    ...
    <header class="hero hero--tall">
        <div class="hero__row">
          <a class="back" href="#" onclick="event.preventDefault(); history.back();" aria-label="Back"> 
          ...
          ?> 
              <a data-alert="homework-en" data-idx="<?php echo $notif_index; ?>" class="row<?php echo $row_hidden_class; ?> <?php if($row_get_notifications['view']==0){echo " t-green ";} ?>" href="parent-alert.php?id=<?php echo $row_get_notifications['id']; ?>&kid=<?php echo $row_get_kids_list['kid_id'];?>">
                  ...
                  <div class="row__body">
                    ...
                    <p class="row__meta"> <?php if(!isset($_GET['kid'])){ echo kid_name($row_get_kids_list['kid_id'])." - " ;}   if($row_get_notifications['type'] == 1){echo " Absence";} if($row_get_notifications['type'] == 6){echo " Announcement";}if($row_get_notifications['type'] == 65){echo " Message";}   ?></p>
