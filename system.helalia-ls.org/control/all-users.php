...
if ($row_get_login['access100'] == 1) {
  ...
  if ($_SESSION['MM_Username'] == 'admin') {
    $query_get_users_info = "SELECT * FROM `users` where `id` !=1    ";
  } else {
    $query_get_users_info = "SELECT * FROM `users` where `id` !=1 and `id` !=1015 ";
  }
    ...
    <div class="layout-header">
      <div class="navbar navbar-default">
        <div class="navbar-header" style=" background-color: black">
          <?php require_once('includes/header-logo.php'); ?>
                  ...
                  <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0"
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="text-center"> لبريد اللإلكتروني</th>
                      ...
                      <?php if ($totalRows_get_users_info > 0) {
                        do { ?>
                          <tr>
                            ...
                            <td class="text-center"><?php echo $row_get_users_info['username']; ?></td>
                            <td class="text-center">
                              <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                  <li><a href="edit-user.php?id=<?php echo $row_get_users_info['id']; ?>"> <i
                                        class="fa fa-pencil-square-o" aria-hidden="true" style="color: green"></i> تعديل </a>
                                  </li>

                                  <?php if ($row_get_users_info['id'] != 1) { ?>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="edit-user.php?del=<?php echo $row_get_users_info['id']; ?>"
