...
<html lang="en" dir="rtl">
  ...
  <style>
    @media print {
      ...
      #court-datatables{ width:100% !important;}
    }
  </style>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
  ...
  <body class="layout layout-header-fixed"> 
    ...
    <div class="layout-header noprint">
    ...
    <div class="layout-main ">
      ...
      <div class="row" style="width: 100%;   margin: 0 auto; box-sizing: border-box;">
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable print-only-table" cellspacing="0" width="100%" style="font-size: 16px; max-width: 100% !important;">
                  <thead>
                    <tr> 
	...
	$("#court-datatables").DataTable({
            ...
            buttons: [
            {
              ...
              text: 'Print',
                ...
                window.open('parents-speed-report-print.php<?php echo "?from=" . urlencode($_GET['from']) . "&to=" . urlencode($_GET['to']); ?>', '_blank');
                }
            },
            'copy'
        ],
