              ...
              if (!in_array($mime_type, $allowed_mimes)) {
                  ...
                  if ($src_img === false) {
                      ...
                      if (imagejpeg($dst_img, $save_path, 85)) {
                          ...
                          if ($old_picture && $old_picture !== 'no-picture.png' && file_exists($upload_dir . $old_picture)) {
...
<div class="app">
  ...
  <!--Top quick links-->
    ...
    <a class="tile t-coral" href="parent-homework.php?id=<?php echo $row_get_kid_info['id'];?>">
      <?php if($row_get_homework_count['homework']>0){ ?><span class="tile__new"><?php echo $row_get_homework_count['homework']; ?></span><?php } ?>
    ...
    <a class="tile t-blue" href="parent-memo.php?id=<?php echo $row_get_kid_info['id'];?>">
      <?php if($row_get_memo_count['memo']>0){ ?><span class="tile__new"><?php echo $row_get_memo_count['memo']; ?></span><?php } ?>
    ...
    <a class="tile t-gold" href="parent-revision.php?id=<?php echo $row_get_kid_info['id'];?>">
      <?php if($row_get_revision_count['revision']>0){ ?><span class="tile__new"><?php echo $row_get_revision_count['revision']; ?></span><?php } ?>
...
<!-- Bottom navigation -->
  ...
  <div class="pic-modal" id="pic-modal">
    ...
    <div class="pic-modal__box" role="dialog" aria-modal="true" aria-labelledby="pic-modal-title">
      ...
      <form action="parent-kid2.php?id=<?php echo $kid_id;?>" method="post" enctype="multipart/form-data" id="pic-upload-form">
