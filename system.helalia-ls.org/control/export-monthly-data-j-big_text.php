        ...
        <?php } ?>
			 ...
			 <div class="card" id="printable_div_id" style=" width: 100%; font-size: 12px;"> 
                ...
                <table  id="court-datatables-kids1" class="table table-striped table-nowrap dataTable" border="1" cellspacing="0" width="100%" style="font-size: 12px " <?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  ' dir="ltr" ';}?> >
                    <thead> 
                        <tr>
                            <td rowspan="3" style="text-align: center; vertical-align: middle; font-size: 16px !important; width: 15px;" >م  </td>
                            <td rowspan="3" style="text-align: center; vertical-align: middle; font-size: 16px !important;" >الاســـــم   </td>
                            <td colspan="10" style="text-align: center; font-weight: bold; font-size: 16px !important;"><?php $dateObj = DateTime::createFromFormat('!m', $_GET['month']);
                                    echo $dateObj->format('F'); ?>
                            </td>
                            <td colspan="10" style="text-align: center;  font-weight: bold; font-size: 16px !important;"><?php $dateObj = DateTime::createFromFormat('!m', ($_GET['month']+1));
                                    echo $dateObj->format('F'); ?>
                            </td>
                            <td colspan="10" style="text-align: center;  font-weight: bold; font-size: 16px !important;"><?php $dateObj = DateTime::createFromFormat('!m', ($_GET['month']+2));
                                    echo $dateObj->format('F'); ?>
                            </td>
                        </tr>
                        <tr>  
                            <th class="text-center"  style="width: 30px;"> كراسة <br>واجب </th>    
                            <th class="text-center"  style="width: 30px;"> كراسة <br>نشاط </th>    
                            <th class="text-center"  style="width: 30px;">تقيم<br>1</th>  
                            <th class="text-center"  style="width: 30px;">تقيم<br>2</th>    
                            <th class="text-center"  style="width: 30px;">تقيم<br>3</th>     
                            <th class="text-center"  style="width: 30px;">تقيم<br>4</th>     
                            <th class="text-center"  style="width: 30px;"> متوسط <br>تقيمات </th>  
                            <th class="text-center"  style="width: 30px;"> مهام<br>الادائية </th>   
                            <th class="text-center"  style="width: 30px;"> المواظبة </th>
                            <th class="text-center"  style="width: 30px;"> المجموع </th>
            ...
            for($i=$_GET['month'];$i<=($_GET['month']+2);$i++){ 
                         if($totalRows_get_data>0){
                            $x=1;  do{ if($row_get_data['id']!=NULL){?>
                        <tr>  
                            <td class="text-center" style=" border:solid 1px black; vertical-align: middle; "><?php echo $x;?></td>
                            <td class="text-<?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  'left';}else{echo 'right';}?>" style="width:130px; text-align:<?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  'left';}else{echo 'right';}?>; border:solid 1px black; font-size: 13px !important; padding-top:1px !important; padding-bottom: 1px !important; color: black; padding-left: 3px !important; padding-right:5px !important; "><?php  if(isset($_GET['lang']) && $_GET['lang']==2){echo $row_get_data['fn_name'];}else{echo $row_get_data['name'];} ?></td> 
                ...
                <table  id="court-datatables-kids2" class="table table-striped table-nowrap dataTable" border="1" cellspacing="0" width="100%" style="font-size: 10px !important "  <?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  ' dir="ltr" ';}?> >
                    <thead> 
                        ...
                        <tr> 
                            <th class="text-center" style="width: 120px; font-size: 14px !important;">كراسة الواجب والحصة</th>     
                            <th class="text-center" style="width: 120px; font-size: 14px !important;">كراسة النشاط  </th>        
                            <th class="text-center" style="width: 120px; font-size: 14px !important;">التقيم    </th>  
                            <th class="text-center" style="width: 120px; font-size: 14px !important;">  مواظية وسلوك</th>  
                            <th class="text-center" style="width: 120px; font-size: 14px !important;">مهام ادائية</th>       
