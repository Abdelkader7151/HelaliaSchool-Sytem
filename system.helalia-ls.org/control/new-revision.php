<?php require_once('includes/access.php'); 
 ...
 if($row_get_login['access21sub1']==1){
...
if(isset($_POST['submit'])){    
    ...
    for($i=0;$i<$countfiles;$i++){  
        ...
        if($error == 0){   
            ...
            move_uploaded_file($_FILES['file']['tmp_name'][$i],'../homework/'.$image_name);
                              ...
                              $insertSQL = sprintf("INSERT INTO `revision` ( `name_eng`, `study_year`, `class`,  `subject`, `text_eng`, `start`, `date`, `banner`, `admin_id`, `app_id`, `confirm`, `confirm_by_admin`) VALUES (  %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )",
  ...
  if(isset($_POST['notification']) && $_POST['notification']==1){
    ...
    $message  ='Revision: '.subject_name($_POST['subject']);
    ...
    sendMessage($row_get_target['phone_id'],'HLS',$message); 
       ...
       header("location: new-revision.php?done"); 
		  	exit(); 
	} 
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4> أضافة مراجعة جديد </h4>
            </div>
          </div>
			<div class="row">
				<div class="col-md-8">
				  <div class="demo-form-wrapper">
                    <form action="new-revision.php" method="post" name="form1" id="demo-inputmask"  enctype="multipart/form-data" class="form form-horizontal">
