...
if(isset($_GET['id'])){ 
  ...
  if($_GET['id']>14){ $study_year = " AND `study_year` >= '{$_GET['id']}' "; }
                ...
                <table id="court-datatables" class="table table-striped  dataTable" width="100%" style="font-size: 16px;  ">
                    ...
                    <tbody>
                      ...
                      <tr class="count"> 
                        ...
                        <td class="text-left"><?php echo $row_get_users_info['fn_name'];?></td> 
 ...
 <script>
	  $(document).ready(function(){ 
        ...
        $("#court-datatables").DataTable({
            ...
            "aoColumnDefs": [
               { "bSortable": false,
                 "aTargets": [ <?php if($_GET['id']==13 || $_GET['id']==14){echo 11;}else{echo 9;}?> ]
               }
             ]
        });
