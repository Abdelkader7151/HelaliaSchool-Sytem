...
$query_get_new_contacts = "SELECT * FROM `contacts`  where  `account_type`=2 order by `id` asc  "; 
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td class="text-center"><?php if($row_get_new_contacts['view']==0){echo " جديد ";}else{ echo " قديم";}?></td>  
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right"> 
                                ...
                                <li><a href="view-app-msg.php?id=<?php echo $row_get_new_contacts['id'];?>" >  <i class="fa fa-eye" aria-hidden="true" style="color: green"></i>  عرض </a></li>
							    <li role="separator" class="divider"></li> 
								<li><a href="view-app-msg.php?del=<?php echo $row_get_new_contacts['id'];?>" onClick="return confirm('تاكيد؟');">  <i class="fa fa-trash-o" aria-hidden="true" style="color: red"></i>  حذف </a></li>
