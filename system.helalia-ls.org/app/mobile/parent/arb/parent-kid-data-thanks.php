...
<div class="app">
    ...
    <div class="hero__row">
      <a class="back" href="parent-view.php" aria-label="رجوع">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          <path d="M15 19 8 12l7-7"/></svg></a><h1 class="hero__title">  شكرا</h1>
         <div class="bells">
  ...
  <div class="thanks">
    <span class="thanks__mark"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m5 12.5 4.5 4.5L19 7.5"/></svg></span>
    <h2 class="thanks__title">شكرًا لك</h2>
    <p class="thanks__body">سنقوم بمراجعة بياناتك وتنشيط حسابك.</p>
  </div>
