...
<div class="app">  
  ...
  <header class="hero hero--tall">
    <div class="hero__row">
        <a class="back" href="parent-kid.php?id=<?php echo $row_get_kid_data['id'];?>" aria-label="رجوع">
         ...
         <h1 class="hero__title">  مراجعة</h1>
         <div class="bells">
  ...
  <main class="page">
      ...
      <div class="tabs">
        <a class="tab " href="parent-homework.php?id=<?php echo $row_get_kid_data['id'];?>">الواجب المنزلي</a>
        <a class="tab is-active" href="parent-revision.php?id=<?php echo $row_get_kid_data['id'];?>">مراجعة</a> 
      </div>
