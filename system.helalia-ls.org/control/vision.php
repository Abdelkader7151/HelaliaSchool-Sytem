...
if(isset($_POST['submit'])){  
	$insertSQL = sprintf("UPDATE `settings` SET `vision_eng`=%s, `vision_arb`=%s, `vision_frn`=%s WHERE `id`=1 ", 
                                GetSQLValueString($database,$_POST['vision_eng'], "text"),
                                GetSQLValueString($database,$_POST['vision_arb'], "text"),
                                GetSQLValueString($database,$_POST['vision_frn'], "text"));

       mysqli_select_db($database, $database_database);   
       $Result1 = mysqli_query($database,$insertSQL) or die(mysqli_error($database));

       
			header("location: vision.php?id=".$_POST['id']."&done"); 
			exit();
			...
			<div class="row">
				<div class="col-md-10">
				  <div class="demo-form-wrapper">
                    <form action="vision.php" method="post" name="form1" id="demo-inputmask"  enctype="multipart/form-data" class="form form-horizontal">
                    
					  <div class="form-group">
              <label class="col-sm-3 control-label" for="name">  الانجليزية <span style="color: red;">*</span></label>
              <div class="col-sm-9">
                <textarea   id="vision_eng" class="form-control text_editor"    name="vision_eng" ><?php echo $row_get_settings['vision_eng'];?></textarea>
              </div>
                      </div> 
              ...
              <div class="col-sm-9">
                <textarea   id="vision_frn" class="form-control text_editor"    name="vision_frn" ><?php echo $row_get_settings['vision_frn'];?></textarea>
              </div>
                      </div> 
              ...
              <div class="col-sm-9">
                <textarea   id="vision_arb" class="form-control text_editor"    name="vision_arb" ><?php echo $row_get_settings['vision_arb'];?></textarea>
              </div>
					  </div> 
