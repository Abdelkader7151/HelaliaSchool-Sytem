...
<div class="app">
  <header class="hero hero--tall">
    <div class="hero__row">
      <a class="back" href="parent-kid.php?id=<?php echo $kid_id;?>" aria-label="Back">
        ...
        <h1 class="hero__title">Homework</h1>
        <div class="bells">
  ...
  <main class="page">
      ...
      <div class="tabs">
        <a class="tab is-active" href="parent-homework.php?id=<?php echo $row_get_kid_data['id'];?>">Homework</a>
        <a class="tab" href="parent-revision.php?id=<?php echo $row_get_kid_data['id'];?>">Revision</a> 
      </div>
