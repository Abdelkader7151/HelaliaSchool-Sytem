			...
			<div class="row">
				<div class="col-md-8">
				  <div class="demo-form-wrapper">
                    <form action="all-control-year.php" method="get" name="form1" id="demo-inputmask"  enctype="multipart/form-data" class="form form-horizontal">
                    ...
                    <thead>
                      <tr>  
                        ...
                        <?php if($totalRows_get_subject_header>0){
                          do{?>
                        <th class="text-center"  >   <?php echo $row_get_subject_header['name']?> F1</th>   
                        <th class="text-center" >   <?php echo $row_get_subject_header['name']?> F2</th>   
                    ...
                    <tbody>
                      ...
                      <?php 
                        ...
                        if($totalRows_get_subject_result>0){
                          do{
                            mysqli_select_db($database, $database_database);  
                            $query_get_users_info = "SELECT * FROM `control_year` WHERE `kid_id` ='{$row_get_data['id']}' AND  `study_year`= '{$_GET['year']}' AND  `subject_id`='{$row_get_subject_result['id']}' ";    
                            ...
                            ?>
                              <td class="text-center"  style=" border:solid 1px gray"><?php echo $row_get_users_info['phase1_result'];?> </td>   
                              <td class="text-center"  style=" border:solid 1px gray"><?php echo $row_get_users_info['phase2_result'];?> </td>   
