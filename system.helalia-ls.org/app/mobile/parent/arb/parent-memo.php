...
<div class="app">
  ...
  <main class="page">
    ...
    <div class="rows">
      ...
      <?php }while($row_get_data_today = mysqli_fetch_assoc($get_data_today));
        ...
        <a class="row " href="#">لم يتم العثور على أي مذكرة</a>    
        <?php } ?>     
  </div>
 ...
 <div class="rows">
      ...
      <?php if($totalRows_get_data_old >0){ ?>
         <button class="btn btn--quiet btn--more" id="hw-more" type="button">تحميل المزيد</button>
      <?php } ?>
