...
$query_get_users_info = "SELECT * FROM `app_login` order by `name` asc  "; 
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td class="text-center"><?php if($row_get_users_info['account_type']==1){echo " ولي امر";}else{ echo " موظف";}?></td> 
