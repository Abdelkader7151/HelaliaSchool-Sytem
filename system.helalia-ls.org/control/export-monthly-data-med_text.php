       ...
       <?php } ?>
			 ...
			 <div class="card" id="printable_div_id" style=" width: 100%; font-size: 12px;"> 
                ...
                <table  id="court-datatables-kids1" class="table table-striped table-nowrap dataTable" border="1" cellspacing="0" width="100%" style="font-size: 12px "  <?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  ' dir="ltr" ';}?>>
                    <thead> 
                        ...
                        <tr> 
                            <th class="text-center" style="width: 45px;">كراسة<br> الواجب</th>    
                            <th class="text-center" style="width: 45px;">تقيم<br>1</th>  
                            <th class="text-center" style="width: 45px;">تقيم<br>2</th>    
                            <th class="text-center" style="width: 45px;">تقيم<br>3</th>     
                            <th class="text-center" style="width: 45px;">تقيم<br>4</th>     
                            <th class="text-center" style="width: 45px;"> مجموع <br>تقيمات </th>  
                            <th class="text-center" style="width: 45px;">المواظبة  </th>   
                            <th class="text-center" style="width: 45px;"> المجموع </th>
            ...
            for($i=$_GET['month']; $i<=($_GET['month']+2);$i++){ 
                  ...
                  <div class="card-body" data-toggle="match-height"  style="overflow-x:auto;  " > 
                      ...
                      <table id="court-datatables-kids2" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px ">
                        <thead>
                            <tr>  
                                <th class="text-right"  style="width: 33%; text-align: right;  font-size: 16px !important; padding:5px !important;" >ادارة شرق التعليمية<br> مدرسة هلالية للغات  </th>  
                                <th class="text-center" style="width: 34%;  font-size: 16px !important;" ><?php echo year_of_study($_GET['year']);?> <br> <?php echo class_name($_GET['class']);?></th> 
                ...
                <table  class="table table-striped table-nowrap dataTable" border="1" cellspacing="0" width="100%" style="font-size: 12px "  <?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  ' dir="ltr" ';}?>>
                    <thead> 
                        <tr>
                            <td rowspan="3" style="text-align: center; vertical-align: middle; font-size: 16px !important;" >م  </td>
                            <td rowspan="3" style="text-align: center; vertical-align: middle; width: 140x;  font-size: 16px !important;" >الاســـــم   </td>
                            <td colspan="7" style="text-align: center; font-weight: bold; font-size: 16px !important;"> متوسط </td>  
                          
                        </tr>
                        <tr> 
                            <th class="text-center"  style="width: 130px; font-size: 14px !important;">كراسة الواجب والحصة</th>    
                            <th class="text-center"  style="width: 130px; font-size: 14px !important;">  التقيمات</th>  
                            <th class="text-center"  style="width: 130px; font-size: 14px !important;">مواظية وسلوك</th>  
                            <th class="text-center"  style="width: 130px; font-size: 14px !important;">مجموع</th>   
                            <th class="text-center"  style="width: 130px; font-size: 14px !important;"> شهر 1</th>   
                            <th class="text-center"  style="width: 130px; font-size: 14px !important;"> شهر 2</th>   
                            <th class="text-center"  style="width: 130px; font-size: 14px !important;"> المجموع </th> 
                       </tr>
                       <tr>  
                            <th class="text-center">10</th>   
                            <th class="text-center">20</th>  
                    ...
                    <tbody>
                       <?php 
                        ...
                        <tr>  
                            <td class="text-center" style=" border:solid 1px black; vertical-align: middle;"><?php echo $x;?></td>
                            <td class="text-<?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  'left';}else{echo 'right';}?>" style=" text-align:<?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  'left';}else{echo 'right';}?>; border:solid 1px black;  font-size: 14px !important; padding-top: 2px !important; padding-bottom: 2px !;color: black; padding-left: 3px !important;  padding-right:5px !important;"><?php  if(isset($_GET['lang']) && $_GET['lang']==2){echo $row_get_data['fn_name'];}else{echo $row_get_data['name'];} ?></td> 
                ...
                <table id="court-datatables-kids3" class="table table-striped table-nowrap dataTable" border="1" cellspacing="0" width="100%" style="font-size: 12px "  <?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  ' dir="ltr" ';}?>>
                    <thead>
                        <tr>
                            ...
                            <td colspan="<?php echo $z1;?>" style="text-align: center;  font-weight: bold; font-size: 14px !important;"><?php $dateObj = DateTime::createFromFormat('!m', $_GET['month']);
                                    echo $dateObj->format('F'); ?>    
                            </td>

                              <td colspan="<?php echo $z2;?>" style="text-align: center;  font-weight: bold; font-size: 14px !important;"><?php $dateObj = DateTime::createFromFormat('!m', ($_GET['month']+1));
                                    echo $dateObj->format('F'); ?>     
                            </td>

                             <td colspan="<?php echo $z3;?>" style="text-align: center;  font-weight: bold; font-size: 14px !important;"><?php $dateObj = DateTime::createFromFormat('!m', ($_GET['month']+2));
                                    echo $dateObj->format('F'); ?>    
                            </td>
                        </tr> 
                       <tr>  
            ...
            if($totalRows_get_data>0){
                        ...
                        <tr>  
                            <td class="text-center" style=" border:solid 1px black;  vertical-align: middle;"><?php echo $x;?></td>
                             <td class="text-<?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  'left';}else{echo 'right';}?>" style="text-align:<?php if(isset($_GET['lang']) && $_GET['lang']==2){ echo  'left';}else{echo 'right';}?>; width:140px; border:solid 1px black;  font-size: 14px !important; padding-top:2px !important; padding-bottom: 1px !important;color: black; padding-left: 3px !important;  padding-right:5px !important;"><?php  if(isset($_GET['lang']) && $_GET['lang']==2){echo $row_get_data['fn_name'];}else{echo $row_get_data['name'];} ?></td>  
                           <?php  
                            $days1 = cal_days_in_month(CAL_GREGORIAN, $_GET['month'], date("Y",time()));  
                            for($i=1;$i<=$days1;$i++){
                            if(date('l', strtotime($_GET['month']."/".$i."/".date("Y",time())))!="Saturday" && date('l', strtotime($_GET['month']."/".$i."/".date("Y",time())))!="Friday"){?>
