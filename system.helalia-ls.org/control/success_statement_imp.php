           ...
           // if(($highestRow-2)==$totalRows_get_data && $error==0){
            if($totalRows_get_data && $error==0){
              ...
              do{  
                ...
                mysqli_select_db($database, "db"); 
                $query_get_check = "SELECT `gov_id` FROM `success_statement` WHERE `gov_id` = '{$row_get_data['gov_id']}' AND `study_year`='{$row_get_data['study_year']}' AND `type` ='{$_POST['type']}' ";
                ...
                $totalRows_get_check = mysqli_num_rows($get_check);
                    ...
                    if($totalRows_get_check>0){ mysqli_query($database, " DELETE FROM `success_statement` WHERE `gov_id` = '{$row_get_data['gov_id']}' AND `study_year`='{$row_get_data['study_year']}' AND `type` ='{$_POST['type']}'  ");  }

                $insertSQL2 = sprintf("INSERT INTO `success_statement` (
                    `gov_id`, `date`, `year`, `title_eng`, `title_arb`, `title_frn`, `study_year`, `class`, `type`,
                        `subject1`, `subject2`, `subject3`, `subject4`, `subject5`, `subject6`, `subject7`, `subject8`, `subject9`, `subject10`, `subject11`, `subject12`, `subject13`, `subject14`, `subject15`,
                        `subject16`, `subject17`, `subject18`, `subject19`, `subject20`, `subject21`, `subject22`, `subject23`, `subject24`, `subject25`, `subject26`, `subject27`, `subject28`, `subject29`, `subject30`,
                        `subject1_total`, `subject2_total`, `subject3_total`, `subject4_total`, `subject5_total`, `subject6_total`, `subject7_total`, `subject8_total`, `subject9_total`, `subject10_total`, `subject11_total`, `subject12_total`, `subject13_total`, `subject14_total`, `subject15_total`,
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4>         تحميل بيان النجاح  </h4>
            </div>
          </div>
			<div class="row">  
				<div class="col-md-4">
				  <div class="demo-form-wrapper"> 
                    <form action="success_statement_imp.php" method="POST" name="form1" id="demo-inputmask2"  enctype="multipart/form-data" class="form form-horizontal">
                    
  <input id="title_arb" type="hidden" name="title_arb"   >
  <input id="title_eng" type="hidden" name="title_eng"    >		   
  <input id="title_frn" type="hidden" name="title_frn"   >        
            ...
            <label class="col-sm-3 control-label" for="year"> العام  </label> 
            <div class="col-sm-4"> 
                <input type="number" name="year" value="<?php echo date("Y",time()); ?>"    >          
						</div>
            </div>  
