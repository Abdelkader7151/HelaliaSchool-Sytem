...
if ($row_get_login['access100'] == 1) {
  ...
  if (isset($_POST['submit'])) {
    $insertSQL = sprintf("UPDATE `users` SET  `password`= %s, `name`= %s,
  `access1`= %s, `access1sub1`= %s, `access1sub2`= %s, `access1sub3`= %s, `access1sub4`= %s,
  `access2`= %s, `access2sub1`= %s, `access2sub2`= %s, `access2sub3`= %s, `access2sub4`= %s, `access2sub5`= %s, `access2sub6`= %s,
  `access3`= %s, `access3sub1`= %s, `access3sub2`= %s, `access3sub3`= %s, `access3sub4`= %s, 
  `access4`= %s, `access4sub1`= %s, `access4sub2`= %s, `access4sub3`= %s, `access4sub4`= %s,`access4sub5`= %s, `access4sub6`= %s,
  `access5`= %s, `access5sub1`= %s, `access5sub2`= %s, `access5sub3`= %s, `access5sub4`= %s, 
  `access6`= %s, `access6sub1`= %s, `access6sub2`= %s, `access6sub3`= %s, `access6sub4`= %s,`access6sub5`= %s, `access6sub6`= %s, `access6sub7`= %s,
  `access7`= %s, `access7sub0`= %s, `access7sub1`= %s, `access7sub2`= %s, `access7sub3`= %s, `access7sub4`= %s,`access7sub5`= %s, `access7sub6`= %s, `access7sub7`= %s,  `access7sub8`= %s, `access7sub9`= %s,  `access7sub11`= %s,    
  `access8`= %s, `access8sub1`= %s, `access8sub2`= %s, `access8sub3`= %s, `access8sub4`= %s, 
  `access9`= %s, `access9sub1`= %s, `access9sub2`= %s,
  `access10`= %s, `access10sub1`= %s, `access10sub2`= %s, `access10sub3`= %s,
  `access11`= %s, `access11sub1`= %s, `access11sub2`= %s,
  `access12`= %s, `access12sub1`= %s, `access12sub2`= %s, `access12sub3`= %s,
  `access13`= %s,
  `access14`= %s,
  `access15`= %s, 
  `access16`= %s, 
  `access17`= %s, `access17sub1`= %s, `access17sub2`= %s, `access17sub3`= %s, `access17sub4`= %s,
  `access18`= %s, `access18sub1`= %s, `access18sub2`= %s, `access18sub3`= %s, `access18sub4`= %s, `access18sub5`= %s, `access18sub6`= %s, `access18sub7`= %s, `access18sub8`= %s, `access18sub9`= %s, `access18sub10`= %s, `access18sub11`= %s, `access18sub12`= %s,  `access18sub13`= %s,  `access18sub14`= %s,  `access18sub15`= %s, 
  `access19`= %s, `access19sub1`= %s, `access19sub2`= %s, `access19sub3`= %s,
  `access20`= %s, `access20sub1`= %s, `access20sub2`= %s,  
  `access21`= %s, `access21sub1`= %s, `access21sub2`= %s, `access21sub3`= %s,
  `access22`= %s,  
  ...
  `access100`= %s, `access100sub1`= %s, `access100sub2`= %s, `access100sub3`= %s  WHERE `id` = %s",
    ...
    header("location: all-users.php?done");
    exit();
  }


  mysqli_select_db($database, $database_database);
  $query_get_users_info = "SELECT * FROM `users` where `id`='{$_GET['id']}'  ";
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="demo-form-wrapper">
                <form action="edit-user.php?id=<?php echo $_GET['id']; ?>" method="post" name="form1" id="form1"
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input id="name" class="form-control" required type="text" name="name"
                        value="<?php echo $row_get_users_info['name']; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input id="username" class="form-control" required type="email" name="username"
                        value="<?php echo $row_get_users_info['username']; ?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input id="password" class="form-control" required type="text" name="password"
                        value="<?php echo $row_get_users_info['password']; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      ...
                      <div class="col-sm-4">
                        <input type="checkbox" id="access1" name="access1" value="1" <?php if ($row_get_users_info['access1'] == 1) {
                          echo " checked ";
                        ...
                        <div
                          ...
                          <input type="checkbox" class="access1" id="access1sub1" name="access1sub1" value="1" <?php if ($row_get_users_info['access1sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access1sub1"> فصل جديد </label><br>
                          <input type="checkbox" class="access1" id="access1sub2" name="access1sub2" value="1" <?php if ($row_get_users_info['access1sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access1sub2"> جمبع الفصول </label><br>
                          <input type="checkbox" class="access1" id="access1sub3" name="access1sub3" value="1" <?php if ($row_get_users_info['access1sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access1sub3"> تعديل الفصول </label><br>
                          <input type="checkbox" class="access1" id="access1sub4" name="access1sub4" value="1" <?php if ($row_get_users_info['access1sub4'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                        ...
                        <input type="checkbox" id="access2" name="access2" value="1" <?php if ($row_get_users_info['access2'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access2" id="access2sub1" name="access2sub1" value="1" <?php if ($row_get_users_info['access2sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access2sub1"> مجموعة جديد </label><br>
                          <input type="checkbox" class="access2" id="access2sub2" name="access2sub2" value="1" <?php if ($row_get_users_info['access2sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access2sub2"> جمبع مجموعات </label><br>
                          <input type="checkbox" class="access2" id="access2sub3" name="access2sub3" value="1" <?php if ($row_get_users_info['access2sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access2sub3"> تعديل مجموعات </label><br>
                          <input type="checkbox" class="access2" id="access2sub4" name="access2sub4" value="1" <?php if ($row_get_users_info['access2sub4'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access2sub4"> الطلبة </label><br>
                          <input type="checkbox" class="access2" id="access2sub5" name="access2sub5" value="1" <?php if ($row_get_users_info['access2sub5'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access2sub5"> غياب اليوم </label><br>
                          <input type="checkbox" class="access2" id="access2sub6" name="access2sub6" value="1" <?php if ($row_get_users_info['access2sub6'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="access3" name="access3" value="1" <?php if ($row_get_users_info['access3'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access3" id="access3sub1" name="access3sub1" value="1" <?php if ($row_get_users_info['access3sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access3sub1"> أضافة مادة جديد </label><br>
                          <input type="checkbox" class="access3" id="access3sub2" name="access3sub2" value="1" <?php if ($row_get_users_info['access3sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access3sub2"> جمبع المواد </label><br>
                          <input type="checkbox" class="access3" id="access3sub3" name="access3sub3" value="1" <?php if ($row_get_users_info['access3sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access3sub3"> تعديل المواد </label><br>
                          <input type="checkbox" class="access3" id="access3sub4" name="access3sub4" value="1" <?php if ($row_get_users_info['access3sub4'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                        ...
                        <input type="checkbox" id="access4" name="access4" value="1" <?php if ($row_get_users_info['access4'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access4" id="access4sub1" name="access4sub1" value="1" <?php if ($row_get_users_info['access4sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access4sub1"> مقابلة جديد </label><br>
                          <input type="checkbox" class="access4" id="access4sub2" name="access4sub2" value="1" <?php if ($row_get_users_info['access4sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access4sub2"> جمبع المقابلات المتاحة </label><br>
                          <input type="checkbox" class="access4" id="access4sub3" name="access4sub3" value="1" <?php if ($row_get_users_info['access4sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access4sub3"> جمبع المقابلات المحجوزة </label><br>
                          <input type="checkbox" class="access4" id="access4sub4" name="access4sub4" value="1" <?php if ($row_get_users_info['access4sub4'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access4sub4"> جمبع المقابلات </label><br>
                          <input type="checkbox" class="access4" id="access4sub5" name="access4sub5" value="1" <?php if ($row_get_users_info['access4sub5'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="access5" name="access5" value="1" <?php if ($row_get_users_info['access5'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access5" id="access5sub1" name="access5sub1" value="1" <?php if ($row_get_users_info['access5sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access5sub1"> وظيفة جديد </label><br>
                          <input type="checkbox" class="access5" id="access5sub2" name="access5sub2" value="1" <?php if ($row_get_users_info['access5sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access5sub2"> جمبع الوظائف </label><br>
                          <input type="checkbox" class="access5" id="access5sub3" name="access5sub3" value="1" <?php if ($row_get_users_info['access5sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access5sub3"> تعديل الوظائف </label><br>
                          <input type="checkbox" class="access5" id="access5sub4" name="access5sub4" value="1" <?php if ($row_get_users_info['access5sub4'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                        ...
                        <input type="checkbox" id="access6" name="access6" value="1" <?php if ($row_get_users_info['access6'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access6" id="access6sub1" name="access6sub1" value="1" <?php if ($row_get_users_info['access6sub1'] == 1) {
                            echo " checked ";
                          } ?>style="margin-left: 5px;">
                          <label for="access6sub1"> موظف جديد </label><br>
                          <input type="checkbox" class="access6" id="access6sub2" name="access6sub2" value="1" <?php if ($row_get_users_info['access6sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access6sub2"> جميع الموظفين </label><br>
                          <input type="checkbox" class="access6" id="access6sub3" name="access6sub3" value="1" <?php if ($row_get_users_info['access6sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access6sub3"> تعديل موظف </label><br>
                          <input type="checkbox" class="access6" id="access6sub4" name="access6sub4" value="1" <?php if ($row_get_users_info['access6sub4'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access6sub4"> عياد الميلاد </label><br>
                          <input type="checkbox" class="access6" id="access6sub5" name="access6sub5" value="1" <?php if ($row_get_users_info['access6sub5'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access6sub5"> اجازات </label><br>
                          <input type="checkbox" class="access6" id="access6sub6" name="access6sub6" value="1" <?php if ($row_get_users_info['access6sub6'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access6sub6"> اذون </label><br>
                          <input type="checkbox" class="access6" id="access6sub7" name="access6sub7" value="1" <?php if ($row_get_users_info['access6sub7'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="access7" name="access7" value="1" <?php if ($row_get_users_info['access7'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access7" id="access7sub0" name="access7sub0" value="1" <?php if ($row_get_users_info['access7sub0'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub0"> تسجيل جديد </label><br>
                          <input type="checkbox" class="access7" id="access7sub1" name="access7sub1" value="1" <?php if ($row_get_users_info['access7sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub1"> طالب جديد </label><br>
                          <input type="checkbox" class="access7" id="access7sub2" name="access7sub2" value="1" <?php if ($row_get_users_info['access7sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub2"> عرض جميع الطلبة </label><br>
                          <input type="checkbox" class="access7" id="access7sub3" name="access7sub3" value="1" <?php if ($row_get_users_info['access7sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub3"> عياد الميلاد </label><br>
                          <input type="checkbox" class="access7" id="access7sub4" name="access7sub4" value="1" <?php if ($row_get_users_info['access7sub4'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub4"> اجازات جديدى</label><br>
                          <input type="checkbox" class="access7" id="access7sub5" name="access7sub5" value="1" <?php if ($row_get_users_info['access7sub5'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub5"> غياب </label><br>

                          <input type="checkbox" class="access7" id="access7sub8" name="access7sub8" value="1" <?php if ($row_get_users_info['access7sub8'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub8"> رساله </label><br>
                          <input type="checkbox" class="access7" id="access7sub7" name="access7sub7" value="1" <?php if ($row_get_users_info['access7sub7'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub7"> قبول الغياب </label><br>
                          <input type="checkbox" class="access7" id="access7sub9" name="access7sub9" value="1" <?php if ($row_get_users_info['access7sub9'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub9"> بيان نجاح </label><br>

                          <input type="checkbox" class="access7" id="access7sub6" name="access7sub6" value="1" <?php if ($row_get_users_info['access7sub6'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access7sub6"> تعديل بيانات الطالب </label><br>
                          <input type="checkbox" class="access7" id="access7sub11" name="access7sub11" value="1" <?php if ($row_get_users_info['access7sub11'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                        ...
                        <input type="checkbox" id="access8" name="access8" value="1" <?php if ($row_get_users_info['access8'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access8" id="access8sub1" name="access8sub1" value="1" <?php if ($row_get_users_info['access8sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access8sub1"> حسابات البرنامج </label><br>
                          <input type="checkbox" class="access8" id="access8sub2" name="access8sub2" value="1" <?php if ($row_get_users_info['access8sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access8sub2"> حسابات اولياء الامور </label><br>
                          <input type="checkbox" class="access8" id="access8sub4" name="access8sub4" value="1" <?php if ($row_get_users_info['access8sub4'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access8sub4"> حسابات الموظفين </label><br>
                          <input type="checkbox" class="access8" id="access8sub3" name="access8sub3" value="1" <?php if ($row_get_users_info['access8sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="access9" name="access9" value="1" <?php if ($row_get_users_info['access9'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access9" id="access9sub1" name="access9sub1" value="1" <?php if ($row_get_users_info['access9sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access9sub1"> الرسائل الجديدة </label><br>
                          <input type="checkbox" class="access9" id="access9sub2" name="access9sub2" value="1" <?php if ($row_get_users_info['access9sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                        ...
                        <input type="checkbox" id="access10" name="access10" value="1" <?php if ($row_get_users_info['access10'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access10" id="access10sub1" name="access10sub1" value="1" <?php if ($row_get_users_info['access10sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access10sub1"> الرسائل الجديدة </label><br>
                          <input type="checkbox" class="access10" id="access10sub2" name="access10sub2" value="1" <?php if ($row_get_users_info['access10sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access10sub2"> جميع الرسائل </label><br>
                          <input type="checkbox" class="access10" id="access10sub3" name="access10sub3" value="1" <?php if ($row_get_users_info['access10sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="access11" name="access11" value="1" <?php if ($row_get_users_info['access11'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access11" id="access11sub1" name="access11sub1" value="1" <?php if ($row_get_users_info['access11sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access11sub1"> الرسائل الجديدة </label><br>
                          <input type="checkbox" class="access11" id="access11sub2" name="access11sub2" value="1" <?php if ($row_get_users_info['access11sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                        ...
                        <input type="checkbox" id="access12" name="access12" value="1" <?php if ($row_get_users_info['access12'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access12" id="access12sub1" name="access12sub1" value="1" <?php if ($row_get_users_info['access12sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access12sub1"> أضافة مناسبة جديد </label><br>
                          <input type="checkbox" class="access12" id="access12sub2" name="access12sub2" value="1" <?php if ($row_get_users_info['access12sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access12sub2"> عرض جميع المناسبات </label><br>
                          <input type="checkbox" class="access12" id="access12sub3" name="access12sub3" value="1" <?php if ($row_get_users_info['access12sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="access13" name="access13" value="1" <?php if ($row_get_users_info['access13'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        <label for="access13"> <strong style="color:black"> معرض الصور </strong> </label><br>

                        <input type="checkbox" id="access14" name="access14" value="1" <?php if ($row_get_users_info['access14'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        <label for="access14"> <strong style="color:black"> معرض الفيديو </strong> </label><br>

                        <input type="checkbox" id="access15" name="access15" value="1" <?php if ($row_get_users_info['access15'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        <label for="access15"> <strong style="color:black"> شاشات المعلومات </strong> </label><br>

                        <?php if ($row_get_login['id'] == 1) { ?>
                          <input type="checkbox" id="access16" name="access16" value="1" <?php if ($row_get_users_info['access16'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access16"> <strong style="color:black"> النتائج </strong> </label><br>
                        <?php } ?>

                        <input type="checkbox" id="access22" name="access22" value="1" <?php if ($row_get_users_info['access22'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="checkbox" id="access100" name="access100" value="1" <?php if ($row_get_users_info['access100'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access100" id="access100sub1" name="access100sub1" value="1" <?php if ($row_get_users_info['access100sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access100sub1"> مستخدم جديد </label><br>
                          <input type="checkbox" class="access100" id="access100sub2" name="access100sub2" value="1" <?php if ($row_get_users_info['access100sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access100sub2"> جميع المستخدمين </label><br>
                          <input type="checkbox" class="access100" id="access100sub3" name="access100sub3" value="1" <?php if ($row_get_users_info['access100sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        <input type="checkbox" id="access19" name="access19" value="1" <?php if ($row_get_users_info['access19'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access19" id="access19sub1" name="access19sub1" value="1" <?php if ($row_get_users_info['access19sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access19sub1"> اضافة </label><br>
                          <input type="checkbox" class="access19" id="access19sub2" name="access19sub2" value="1" <?php if ($row_get_users_info['access19sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access19sub2"> جمبع الواجبات </label><br>
                          <input type="checkbox" class="access19" id="access19sub3" name="access19sub3" value="1" <?php if ($row_get_users_info['access19sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        <input type="checkbox" id="access21" name="access21" value="1" <?php if ($row_get_users_info['access21'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access21" id="access21sub1" name="access21sub1" <?php if ($row_get_users_info['access21sub1'] == 1) {
                            echo " checked ";
                          } ?> value="1"
                            style="margin-left: 5px;">
                          <label for="aaccess21sub1"> اضافة </label><br>
                          <input type="checkbox" class="access21" id="access21sub2" name="access21sub2" <?php if ($row_get_users_info['access21sub2'] == 1) {
                            echo " checked ";
                          } ?> value="1"
                            style="margin-left: 5px;">
                          <label for="access21sub2"> جمبع المراجعات </label><br>
                          <input type="checkbox" class="access21" id="access21sub3" name="access21sub3" <?php if ($row_get_users_info['access21sub3'] == 1) {
                            echo " checked ";
                          } ?> value="1"
                            style="margin-left: 5px;">
                      ...
                      <div class="col-sm-4">
                        <input type="checkbox" id="access20" name="access20" value="1" <?php if ($row_get_users_info['access20'] == 1) {
                          echo " checked ";
                        } ?> style="margin-left: 5px;">
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access20" id="access20sub1" name="access20sub1" value="1" <?php if ($row_get_users_info['access20sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access20sub1"> اضافة </label><br>
                          <input type="checkbox" class="access20" id="access20sub2" name="access20sub2" value="1" <?php if ($row_get_users_info['access20sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access20sub2"> جمبع الخطط </label><br>
                          <input type="checkbox" class="access20" id="access20sub3" name="access20sub3" value="1" <?php if ($row_get_users_info['access20sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access20sub3"> بحث الخطط </label><br>
                        </div>
                      </div>


                      <div class="col-sm-4">
                        <input type="checkbox" id="access17" name="access17" value="1" style="margin-left: 5px;" <?php if ($row_get_users_info['access17'] == 1) {
                          echo " checked ";
                        } ?>>
                        ...
                        <div
                          style="margin-right: 40px;padding-right: 10px; margin-bottom: 20px; border-right: solid 2px black; ">
                          <input type="checkbox" class="access17" id="access17sub1" name="access17sub1" value="1" <?php if ($row_get_users_info['access17sub1'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access17sub1"> تحصيلات </label><br>
                          <input type="checkbox" class="access17" id="access17sub2" name="access17sub2" value="1" <?php if ($row_get_users_info['access17sub2'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access17sub2"> استحقاقات </label><br>
                          <input type="checkbox" class="access17" id="access17sub3" name="access17sub3" value="1" <?php if ($row_get_users_info['access17sub3'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                          <label for="access17sub3"> اخطار سداد </label><br>
                          <input type="checkbox" class="access17" id="access17sub4" name="access17sub4" value="1" <?php if ($row_get_users_info['access17sub4'] == 1) {
                            echo " checked ";
                          } ?> style="margin-left: 5px;">
                      ...
                      <?php if ($row_get_login['id'] == 1) { ?>
                        <div class="col-sm-4">
                          <input type="checkbox" id="access23" name="access23" value="1" style="margin-left: 5px;" <?php if ($row_get_users_info['access23'] == 1) {
                            echo " checked ";
                          } ?>>
                          ...
                          <div
                            ...
                            <input type="checkbox" class="access23" id="access23sub1" name="access23sub1" value="1"
                              style="margin-left: 5px;" <?php if ($row_get_users_info['access23sub1'] == 1) {
                                echo " checked ";
                              } ?>>
                            <label for="aaccess21sub1"> رصد الدرجات </label><br>
                            <input type="checkbox" class="access23" id="access23sub5" name="access23sub5" value="1"
                              style="margin-left: 5px;" <?php if ($row_get_users_info['access23sub5'] == 1) {
                                echo " checked ";
                              } ?>>
                            ...
                            <input type="checkbox" class="access23" id="access23sub2" name="access23sub2" value="1"
                              style="margin-left: 5px;" <?php if ($row_get_users_info['access23sub2'] == 1) {
                                echo " checked ";
                              } ?>>
                            <label for="access21sub2"> تصدير </label><br>
                            <input type="checkbox" class="access23" id="access23sub3" name="access23sub3" value="1"
                              style="margin-left: 5px;" <?php if ($row_get_users_info['access23sub3'] == 1) {
                                echo " checked ";
                              } ?>>
                            <label for="access23sub3"> التاكيد </label><br>
                            <input type="checkbox" class="access23" id="access23sub4" name="access23sub4" value="1"
                              style="margin-left: 5px;" <?php if ($row_get_users_info['access23sub4'] == 1) {
                                echo " checked ";
                              } ?>>
                            <label for="access23sub4"> اصدار الشهادات </label><br>
                          </div>
                        </div>
                      <?php } ?>

                      <div class="col-sm-4">
                        <input type="checkbox" id="access18" name="access18" value="1" style="margin-left: 5px;" <?php if ($row_get_users_info['access18'] == 1) {
                          echo " checked ";
                        } ?>>
                        ...
                        <div
                          ...
                          <input type="checkbox" class="access18" id="access18sub5" name="access18sub5" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub5'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub6" name="access18sub6" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub6'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub7" name="access18sub7" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub7'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub8" name="access18sub8" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub8'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub9" name="access18sub9" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub9'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub10" name="access18sub10" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub10'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub11" name="access18sub11" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub11'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub12" name="access18sub12" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub12'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub13" name="access18sub13" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub13'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub14" name="access18sub14" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub14'] == 1) {
                              echo " checked ";
                            } ?>>
                          ...
                          <input type="checkbox" class="access18" id="access18sub15" name="access18sub15" value="1"
                            style="margin-left: 5px;" <?php if ($row_get_users_info['access18sub15'] == 1) {
                              echo " checked ";
                            } ?>>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <?php if ($row_get_users_info['id'] != 1) { ?>
                        <a href="edit-user.php?del=<?php echo $row_get_users_info['id']; ?>"
                          onclick="return confirm('تاكيد');" class="btn btn-primary btn-block"><i class="fa fa-trash-o"
