...
while ($row = mysqli_fetch_assoc($get_events)) {
    ...
    $details = "<p>" . $banner . "<br>" . $row['text_eng'] . "<br> <br> <strong>" . $from_to . "</strong></p>";
    $date_title = htmlspecialchars($row['name_eng'], ENT_QUOTES, 'UTF-8')."<br><span style ='font-size:12px; color:green'>".$from_to."</span>";
    $title = htmlspecialchars($row['name_eng'], ENT_QUOTES, 'UTF-8');
