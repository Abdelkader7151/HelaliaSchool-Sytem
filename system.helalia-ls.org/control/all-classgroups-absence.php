<?php require_once('includes/access.php'); 
 ...
 if($row_get_login['access2sub6']==1){
...
$query_get_users_info = "SELECT * FROM `group_absence`  ";   
                ...
                <table id="court-datatables" class="table table-striped  dataTable" width="100%" style="font-size: 16px;  ">
                    ...
                    <tbody>
                      ...
                      <tr class="count"> 
                        ...
                        <td class="text-center"><?php echo date("d/m/Y",$row_get_users_info['day']);?></td>  
