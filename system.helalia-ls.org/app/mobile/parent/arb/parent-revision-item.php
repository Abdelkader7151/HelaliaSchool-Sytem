...
<div class="app">
  <header class="hero hero--tall">
    <div class="hero__row">
      <a class="back" href="parent-revision-view.php?id=<?php echo $row_get_data['subject'];?>&kid=<?php echo $kid_id; ?>" aria-label="رجوع">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          <path d="M15 19 8 12l7-7"/>
        </svg>
      </a>
      <div class="grow">
        <p class="hero__eyebrow">مراجعة</p>
                      ...
                      <div class="fold t-coral">     
                        <button class="fold__head" type="button">
                          ...
                          <span class="fold__body">
                            ...
                            <span class="row__meta"><?php echo $totalRows_get_revision_videos;?> فيديو</span>
                          </span>
    ...
    <div class="fold t-gold">
      <button class="fold__head" type="button">
        ...
        <span class="fold__body">
          ...
          <span class="row__meta"><?php echo $totalRows_get_revision_links;?> رابط</span>
        </span>
        <span class="fold__chev">›</span>
      </button>
      <div class="fold__panel">
