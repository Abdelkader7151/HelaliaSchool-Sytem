<?php require_once('includes/access.php'); 
 ...
 if($row_get_login['access3sub2']==1){
    ...
    if(isset($_GET['del'])){   
        $deleteSQL = sprintf("DELETE FROM `coordinators_teachers` WHERE `cor_id`=%s AND `teacher_id`=%s ",
                ...
                header("location: all-cor-teachers.php?id=".$_GET['id']); 
                exit(); 
        } 
    
mysqli_select_db($database, $database_database);  
$query_get_class_info = "SELECT * FROM `coordinators_teachers_view` WHERE `cor_id` ='{$_GET['id']}' "; 
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4>عرض جميع المدرسين تحت المنسق <?php echo emp_name($_GET['id']);?></h4>
            </div>
          </div>
			<div class="row">
				<div class="col-md-12">
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    <thead>
                      <tr>    
                        <th class="text-left">المدرسين</th> 
	                         ...
	                         do{?>
                                <tr>    
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <li><a href="all-cor-teachers.php?del=<?php echo $row_get_class_info['teacher_id'];?>&id=<?php echo $_GET['id'];?>" onClick="return confirm('تاكيد؟');">  <i class="fa fa-trash-o" aria-hidden="true" style="color: red"></i>  حذف </a></li>
                                        </ul>
                                    </div>
                                    </td>
                                </tr>
