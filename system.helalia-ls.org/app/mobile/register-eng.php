...
<div class="app app--auth">
  <div class="auth">
    ...
    <div class="between">
      ...
      <a class="lang lang--onnavy" href="register-arb.php" hreflang="ar">العربية</a>
    </div>
    ...
    <div class="auth__brand">
      ...
      <p class="auth__tag">Parent app · School management mobile app</p>
    </div>

    <form class="auth__form"  action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" name="form1" id="form1">
      <label class="field"><span class="field__label">Full name</span><input class="input" required type="text" name="name" ></label>
      <label class="field"><span class="field__label">Phone number  <small  class="auth__tag">is for login</small></span><input class="input" required  type="tel" name="phone" placeholder="01xxxxxxxxx"></label>
      <label class="field"><span class="field__label">Email</span><input class="input" required type="email" name="email"  ></label>
      <label class="field"><span class="field__label">Password</span><input class="input" required type="text" minlength="6" maxlength="20" name="password" placeholder="••••••••"></label>
      <button class="btn btn--gold" type="submit" name="submit">Create account</button>
    </form>


    <div class="auth__foot" style="margin-top: 20px;">
      <p class="auth__fine">The school will review your request and activate your account.</p>
      <a class="auth__link" href="login-eng.php?id=<?php echo $_SESSION['phone_id'];?>">Sign in</a>
    </div>
...
<?php if ($error == 1) { ?> 
    ...
    <div class="hl-modal" id="wrong-password" role="alertdialog" aria-live="assertive" aria-label="Login error">
      <div class="hl-modal__box">
        ...
        <p class="hl-modal__text"><?php echo htmlspecialchars(helalia_phone_taken_message('en'), ENT_QUOTES, 'UTF-8'); ?></p>
      </div>
    </div>
