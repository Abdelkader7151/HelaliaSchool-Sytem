        ...
        $highestRow = 0;  
            ...
            for($row=4; $row<=$highestRow; $row++)
                {  
                  ...
                  $name = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(0, trim($row," "))->getValue());  
                  $name = ltrim($name, " ");
                  $name = rtrim($name, " ");
                  ...
                  if($totalRows_get_gov_id==1){
                     ...
                     $subject1_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(1, 3)->getValue()); 
                     $subject2_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(2, 3)->getValue()); 
                     $subject3_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(3, 3)->getValue()); 
                     $subject4_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(4, 3)->getValue()); 
                     $subject5_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(5, 3)->getValue()); 
                     $subject6_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(6, 3)->getValue()); 
                     $subject7_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(7, 3)->getValue()); 
                     $subject8_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(8, 3)->getValue()); 
                     $subject9_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(9, 3)->getValue()); 
                     $subject10_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(10, 3)->getValue()); 
                     $subject11_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(11, 3)->getValue()); 
                     $subject12_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(12, 3)->getValue()); 
                     $subject13_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(13, 3)->getValue()); 
                     $subject14_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(14, 3)->getValue()); 
                     $subject15_total = mysqli_real_escape_string($database, $worksheet->getCellByColumnAndRow(15, 3)->getValue());
            ...
            $row_get_data = mysqli_fetch_assoc($get_data);
            $totalRows_get_data = mysqli_num_rows($get_data);
            if(($highestRow-3)==$totalRows_get_data && $error==0){
              do{  
                ...
                $insertSQL2 = sprintf("INSERT INTO `certificate` (
                    ...
                    `user_id` ) VALUES ( 
                        ...
                        GetSQLValueString2($database,$row_get_login['id'], "int")); 
