...
if(!isset($_GET['id'])){$query_get_class_info = "SELECT * FROM `appointment`  ";} 
if(isset($_GET['id']) && $_GET['id']==1){ $query_get_class_info = "SELECT * FROM `appointment` where `kid_id` IS NULL";  }
if(isset($_GET['id']) && $_GET['id']==2){ $query_get_class_info = "SELECT * FROM `appointment` where `kid_id` IS NOT NULL ";  } 
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			...
			<div class="row">
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    <thead>
                      <tr> 
                       <th class="text-left">المدرس  </th>
                        ...
                        <th class="text-center">الميعاد  </th> 
                        <th class="text-center">الحجز  </th>
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td class="text-center"><?php echo date("d/m/Y",$row_get_class_info['day']);?></td>  
                        <td class="text-center"><?php echo $row_get_class_info['meeting_time'];?></td> 
                        <td class="text-center"><?php echo kid_name($row_get_class_info['kid_id']);?></td> 
                ...
                <li><a href="edit-appointment.php?id=<?php echo $row_get_class_info['id'];?>" >  <i class="fa fa-pencil-square-o" aria-hidden="true" style="color: green"></i>  تعديل </a></li>
               
				<!-- <li><a href="edit-appointment.php?del=<?php //echo $row_get_class_info['id'];?>" onClick="return confirm('تاكيد؟');">  <i class="fa fa-trash-o" aria-hidden="true" style="color: red"></i>  حذف </a></li>-->
