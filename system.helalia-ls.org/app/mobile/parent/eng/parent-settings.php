...
<body>
<div class="app"><header class="hero hero--tall">
    <div class="hero__row">
  ...
  <main class="page">
    ...
    <a class="settings__item" href="../../emp/eng/choose-role.php?fresh=1">
    ...
    <a class="settings__item" href="../arb/parent-settings.php">
      <span>العربية</span>
      <span class="tiny">English</span>
      <span class="settings__go">›</span>
    </a>
