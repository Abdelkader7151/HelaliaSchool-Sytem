...
$query_get_class_info = "SELECT * FROM `class_announce` order by `id` desc  "; 
    ...
    <div class="layout-main">
      ...
      <div class="layout-content">
        <div class="layout-content-body"> 
			<div class="row">
            <div class="col-md-12">
                <h4>عرض جميع اشعارات الفصول من البرنامج    </h4>
            </div>
          </div>
			<div class="row">
				<div class="col-md-12">
                ...
                <table id="court-datatables" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%" style="font-size: 16px">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td class="text-left ow p1" style="white-space:normal !important"> <?php echo $row_get_class_info['msg'];?></td>   
                        <td class="text-center"><?php if($row_get_class_info['class_id']>0){ echo class_name($row_get_class_info['class_id']);}?></td> 
                        <td class="text-center"><?php echo date("d/m/Y",$row_get_class_info['date']);?></td> 
                        <td class="text-center"><?php echo emp_app($row_get_class_info['emp_id']);?></td>  
